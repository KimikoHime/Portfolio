		...
		<div class="content">
			<div class="container">
				...
				<div class="row project valign wrapper">
					<div class="small-12 medium-6 large-4 columns">
						<div class="title unveil" >
							<a href="<?php echo PUBLIC_PATH ?>projet/1" data-hover="<?= $projects[0]->{'name'} ?>">
								<?= $projects[0]->{'name'} ?>
							</a>
						</div>
				...
				<div class="row project valign middle-project wrapper">
					<div class="small-12 medium-6 large-8 columns align-left">
						<a href="<?php echo PUBLIC_PATH ?>projet/2" data-hover="<?= $projects[1]->{'name'} ?>">
				...
				<div class="row project valign wrapper">
					<div class="small-12 medium-6 large-4 columns">
						<div class="title unveil">
							<a href="<?php echo PUBLIC_PATH ?>projet/3"  data-hover="<?= $projects[2]->{'name'} ?>">
								<?= $projects[2]->{'name'} ?></div>
							</a>
